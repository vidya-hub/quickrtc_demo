...
import { CreateTransportParams, ConnectTransportParams, ProduceParams, ConsumeParams } from "./transport";
import type { RtpCapabilities, DtlsParameters, MediaKind, RtpParameters } from "mediasoup/types";
...
export interface ClientToServerEvents {
    joinConference: (data: JoinConferenceRequest, callback: (response: SocketResponse<JoinConferenceResponse>) => void) => void;
    leaveConference: (data: LeaveConferenceRequest, callback: (response: SocketResponse) => void) => void;
    createTransport: (data: CreateTransportParams, callback: (response: SocketResponse<CreateTransportResponse>) => void) => void;
    connectTransport: (data: ConnectTransportParams, callback: (response: SocketResponse) => void) => void;
    produce: (data: ProduceParams, callback: (response: SocketResponse<ProduceResponse>) => void) => void;
    consume: (data: ConsumeParams, callback: (response: SocketResponse<ConsumerParams>) => void) => void;
    pauseProducer: (data: ProducerControlRequest, callback: (response: SocketResponse) => void) => void;
    resumeProducer: (data: ProducerControlRequest, callback: (response: SocketResponse) => void) => void;
    closeProducer: (data: ProducerControlRequest, callback: (response: SocketResponse) => void) => void;
    closeConsumer: (data: CloseConsumerRequest, callback: (response: SocketResponse) => void) => void;
    consumeParticipantMedia: (data: ConsumeParticipantMediaRequest, callback: (response: SocketResponse<ConsumerParams[]>) => void) => void;
    unpauseConsumer: (data: UnpauseConsumerRequest, callback: (response: SocketResponse) => void) => void;
    getParticipants: (data: GetParticipantsRequest, callback: (response: SocketResponse<ParticipantInfo[]>) => void) => void;
}
